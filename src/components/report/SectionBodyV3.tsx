...
import { SectionDefV3, SectionField, ScalarData, RowData, fieldValue, formatValue } from '../../lib/reportSchemaV3';
...
export function ScalarSectionBodyV3({ def, data, onField }: {
  def: SectionDefV3;
  data: ScalarData;
...
export function TableSectionBodyV3({ def, rows, onCell, onAddRow, onDelRow, fixed }: {
  def: SectionDefV3;
  rows: RowData[];
